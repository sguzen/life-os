...
export const DEFAULT_PLAN_CONFIGS: Omit<PlanConfig, 'id' | 'user_id' | 'last_changed_at' | 'last_changed_by' | 'change_reason' | 'created_at'>[] = [
  ...
  { module: 'nutrition', config_key: 'calories_training', config_label: 'Calorie Target (train day)', config_value: '1660', config_type: 'number',  config_unit: 'kcal',   description: 'Daily calorie target on training/run days', editable_by_user: true, editable_by_ai: true },
  { module: 'nutrition', config_key: 'calories_rest',     config_label: 'Calorie Target (rest day)',  config_value: '1525', config_type: 'number',  config_unit: 'kcal',   description: 'Daily calorie target on rest days', editable_by_user: true, editable_by_ai: true },
  { module: 'nutrition', config_key: 'protein_target',    config_label: 'Daily Protein Target',       config_value: '130',  config_type: 'number',  config_unit: 'g',      description: 'Minimum daily protein intake', editable_by_user: true, editable_by_ai: true },
  // Trading gate
